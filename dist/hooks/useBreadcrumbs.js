...
function findTileById(tilemap = null, tile_id) {
    return tilemap ? tilemap.find(entry => entry.tile_id === tile_id) : null;
}
function getCompleteLink(breadcrumbs, slug) {
...
export default function useBreadcrumbs(site_id, sitemap, tilemap = null, title404 = '404 - Seite nicht gefunden') {
    var _a;
                    ...
                    breadcrumbs.push({
                        title: title +
                            (breadcrumbs.length > 0
                                ? ' | ' + ((_a = breadcrumbs[breadcrumbs.length - 1].title) !== null && _a !== void 0 ? _a : '')
                                : ''),
