export declare function readCache(content_type: string, folder?: string | boolean, id?: string | number | boolean, ignore_stale?: boolean, locale?: string): Promise<any>;
export declare function readApiCache(file_name: string): Promise<any>;
export declare function writeContentCache(locale: string | undefined, content_type: string, folder_path: string | boolean | undefined, id: string | number | boolean | undefined, data: any, lifetime?: number | boolean): Promise<void>;
