...
export declare function getCachedFilePath(locale: string | undefined, content_type: string | undefined, folder: string | boolean | undefined, id: string | number | boolean): string;
